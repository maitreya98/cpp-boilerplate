\href{https://app.travis-ci.com/Abhishek-Nalawade/cpp-boilerplate}{\tt } \href{https://coveralls.io/github/Abhishek-Nalawade/cpp-boilerplate?branch=master}{\tt }
...
\begin{DoxyItemize}
\item Maitreya Kulkarni \+: Driver Github\+: maitreya98
\item Markose Jacob \+: Navigator Github\+: markosej11
\end{DoxyItemize}

Part 2
\begin{DoxyItemize}
\item Driver\+: Abhishek Nalawade
\item Navigator\+: Jon Kreinbrink
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Update the activity diagram
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Getting warnings from constructor about wrong intialization order.
\end{DoxyItemize}
